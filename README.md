...
3D Scene is a simple configurable application template to display web scenes.

![Screen Shot](http://coolmaps.esri.com/templates/3DScene/images/thumb.png)

[View it live] (http://coolmaps.esri.com/templates/3DScene)
...
4. If you are using Portal or a local install of the ArcGIS API for JavaScript, change all references to the ArcGIS API for JavaScript in index.html to refer to your local copy of the API. Search for the references containing `"//js.arcgis.com/4.3"` and replace this portion of the reference with the url to your local install.
